...
def lambda_handler(event, context):
    ...
    Placement_ID = int(queryStringParameters['pid'])
    Company_ID   = int(queryStringParameters['cid'])
    ...
    response = table.scan(FilterExpression=Attr('ID').eq(Placement_ID))
    responseBody = { }
    #placements   = []
    ...
    #responseBody['placement'] = placement
